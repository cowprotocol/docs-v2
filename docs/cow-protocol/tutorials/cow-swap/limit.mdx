...
Especially for orders whose traded amounts are small relative to the network fee they require to execute, the market price may have to fall significantly below the limit price to allow execution.
